...
import { Schema as ApplicationBuilderOptions, I18NTranslation, OutputPathClass } from '@angular-devkit/build-angular/src/builders/application/schema';
...
export declare function normalizeOptions(context: BuilderContext, projectName: string, options: ApplicationBuilderInternalOptions, extensions?: ApplicationBuilderExtensions): Promise<{
    ...
    cacheOptions: import("@angular-devkit/build-angular/src/utils/normalize-cache").NormalizedCachedOptions;
    crossOrigin: import("@angular-devkit/build-angular/src/builders/application/schema").CrossOrigin | undefined;
    ...
    stylePreprocessorOptions: import("@angular-devkit/build-angular/src/builders/application/schema").StylePreprocessorOptions | undefined;
    ...
    optimizationOptions: import("@angular-devkit/build-angular/src/utils").NormalizedOptimizationOptions;
    outputOptions: Required<OutputPathClass>;
    outExtension: "js" | "mjs" | undefined;
    sourcemapOptions: import("@angular-devkit/build-angular").SourceMapObject;
    tsconfig: string;
    projectRoot: string;
    assets: import("@angular-devkit/build-angular").AssetPatternObject[] | undefined;
    outputNames: {
        bundles: string;
        media: string;
    };
    ...
    indexHtmlOptions: {
        input: string;
        output: string;
        insertionOrder: import("@angular-devkit/build-angular/src/utils/package-chunk-sort").EntryPointsType[];
    ...
    budgets: import("@angular-devkit/build-angular/src/builders/application/schema").Budget[] | undefined;
